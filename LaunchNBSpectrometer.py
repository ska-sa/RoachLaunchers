...
print ' Coarse FFT shift mask  ', coarseFFTShiftMask
...
#fpga.registers.fine_fft_shift.write_int(fineFFTShift) 
...
fpga.registers.adc0_atten.write_int(ADC_attenuation)
fpga.registers.adc1_atten.write_int(ADC_attenuation)
