...
gateware = 'nb_spectrometer_02_2015_Aug_27_1503'
...
coarseFFTShift = 2047 #shift all stages.
...
print ' Coarse FFT shift mask  ', coarseFFTShift
...
fpga.registers.coarse_fft_shift.write_int(coarseFFTShift) #Shift for each FFT stage (2048 points -> 11 stages. Value is a bit mask so decimal of 11111111111. i.e. 2047)
fpga.registers.coarse_channel_select.write_int(150)
